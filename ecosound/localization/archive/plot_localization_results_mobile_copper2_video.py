...
def plot_full_figure(time_sec=None):
    ...
    indir = r'C:\Users\xavier.mouy\Documents\Publications\Mouy.etal_2022_XAV-Arrays\manuscript\data\mobile_coppers'
    loc_file = r'localization_results.nc'
    audio_file = r'671404070.190921010008.wav'    
    ...
    fig_final.set_size_inches(9.82, 6.72)
...
def main():
    ...
    # movie
    outdir = r'C:\Users\xavier.mouy\Documents\Publications\Mouy.etal_2022_XAV-Arrays\manuscript\data\mobile_coppers\animation'
    fps=20
    duration_sec = 12
